...
import * as fromTests from '../tests/test.reducer';
import { getLoading } from './search';
...
/**
 * A selector function is a factory for mapping functions. Returned function maps from
 * larger state tree into a feature substate tree, destructuring the larger state.
 * This selector selects the `users` state.
 *
 ...
 * 	  this.usersState$ = state$.select(getUsersState);
 * 	}
 * }
 * ```
 */
export const getUsersState = (state: State) => state.users;
export const getUsers = createSelector(getUsersState, fromUsers.getAll);
...
/**
 * This selector selects the `tests` state.
 *
 * Selectors are used with the `select` operator.
 *
 * ```ts
 ...
 * ```
 */
export const getTestsState = (state: State) => state.tests;
export const getTests = createSelector(getTestsState, fromTests.getAll);
export const getTestEntities = createSelector(getTestsState, fromTests.getEntities);
export const getTestIds = createSelector(getTestsState, fromTests.getIds);
export const getSelectedTestId = createSelector(getTestsState, fromTests.getSelectedId);
export const getSelectedTest = createSelector(getTestsState, fromTests.getSelected);
export const getTestsLoading = createSelector(getTestsState, fromTests.getLoading);
