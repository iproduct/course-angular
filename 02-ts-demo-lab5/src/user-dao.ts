...
export interface UserRepository {
    ...
    deleteUserById(id: IdType): void;
    findUserById(id: IdType): User;
    findUserByEmail(email: string): User;
    findAllUsers(): Array<User>;
}

export class DemoUserRepository implements UserRepository {
    private users = new Map<IdType , User>();
    ...
    public deleteUserById(id: IdType): void {
        this.users.delete(id);
    }

    public findUserById(id: IdType): User {
