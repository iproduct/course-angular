function PositionLogger(aPos) {
  var _position = aPos, _positionsLog = [{ val: aPos }];
  // this.position = aPos;
  Object.defineProperty(this, 'position', {
    ...
    // set: function (val) {
    //   _position = val;
    //   this._positionsLog.push({ val: _position });
    // },
    enumerable: true
  });
...
// PositionLogger.prototype.getLog = function () { return this._positionsLog; };

var pl1 = new PositionLogger(5);
console.log('Value: ' + pl1.position);
pl1.position = pl1.position + 20;
console.log('Value: ' + pl1.position);
pl1.position -= 10;
console.log('Value: ' + pl1.position);
