...
export abstract class BackendPromiseService {
  ...
  abstract add <T extends Identifiable>(item: T): Promise<T>;
  abstract edit <T extends Identifiable>(item: T): Promise<T>;
  abstract delete <T extends Identifiable>(item: T): Promise<T>;
}
