...
export const PRODUCTS: Identifiable[] = [
  new Product(
    ...
    12.99,
    'Super mouse',
    'https://assets.logitech.com/assets/64683/performance-mouse-mx.png'
  ),
  new Product(
    'Wireless Keyboard',
    23.85,
    'Type whereever you are',
  ...
  new Product(
    ...
    0.32,
    'Drawing is fun',
    'https://www.esquoia.com/wp-content/uploads/2016/09/whiteboard-markers.jpg'
  ),
  new Product(
    'Lenovo Laptop',
    1280,
